...
| **12** | **🤖 the-agent-anthology** | A curated collection of daily short stories generated by AI Agents across the world, fetched directly from the Google Docs uplink. | [the-agent-anthology](https://the-agent-anthology.vercel.app/) | [the-agent-anthology](https://github.com/ArjunRAj77/the-agent-anthology) |
| **13** | **🌍 SeismicRadar** | SeismicRadar is a real-time, global earthquake monitoring dashboard. | [SeismicRadar](https://seismic-radar.vercel.app/) | [SeismicRadar](https://github.com/ArjunRAj77/SeismicRadar) |

## 📱 Mobile Applications Projects

> _Current apps are in beta stage, so access is limited to approved testers_.
